		...
		<div class="container">
			...
			<div class="row row--grid">
				<div class="col-12 col-lg-7 col-xl-8">
					<form action="contact_us_submit" method="post" class="sign__form sign__form--contacts">
						<div class="row">
							...
							<div class="col-12">
								<div class="sign__group">
									<textarea type="text" name="message" class="sign__textarea" placeholder="Type your message"></textarea>
								</div>
							</div>
				...
				<div class="col-12 col-md-6 col-lg-5 col-xl-4">
					...
					<ul class="contacts__list">
						<li><a href="tel:<?php echo $row['no']?>"><?php echo $row['no']?></a></li>
						<li><a href="mailto:<?php echo $row['mail']?>"><?php echo $row['mail']?></a></li>
						<li><a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="open-map"><?php echo $row['loc']?></a></li>
					</ul>
          <?php
