  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
        ...
        <p class="footer__tagline"><?php echo $row['about']?></p>
      <?php } ?>
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
        <div class="row">
          ...
          <div class="col-6">
            <div class="footer__nav">
              <a href="featured">Featured NFT</a>
              <a href="visual">Virtual NFT</a>
              <a href="audio">Audio NFT</a>
              <a href="video">Video NFT</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
        ...
        <div class="footer__nav">
          <a href="https://windmilltoken.com">Windmill</a>
      ...
      <div class="col-12">
        <div class="footer__content">
          ...
          <div class="footer__social">
            ...
            <a href="mailto:<?php echo $row['mail']?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,4H5A3,3,0,0,0,2,7V17a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V7A3,3,0,0,0,19,4Zm-.41,2-5.88,5.88a1,1,0,0,1-1.42,0L5.41,6ZM20,17a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V7.41l5.88,5.88a3,3,0,0,0,4.24,0L20,7.41Z"/></svg></a>
          </div>

          <small class="footer__copyright">© Windmill Digitak, 2021. Created by <a href="https://windmilltoken.com" target="_blank">Lionel</a>.</small>
        <?php } ?>
        </div>
      </div>
    </div>
